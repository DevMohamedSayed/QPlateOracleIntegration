...
using QPLate_Water.OracleIntegrationAPI.BL.FileUploadRepository;
using QPLate_Water.OracleIntegrationAPI.BL.RoleRepository;
...
using QPLate_Water.OracleIntegrationAPI.DAL.AutoMapper;
...
builder.Services.AddScoped<IAccessPathRepository, AccessPathRepository>();
...
app.MapControllers();
// This is the global error handling middleware & it must be called also before th app.Run();
